...
var img = new Image;
img.src = "https://static.thenounproject.com/png/574893-200.png";
...
function makeSquare(x, y, length, speed) {
  return {
    ...
    s: speed,
    draw: function() {
      	context.drawImage(img, this.x, this.y, this.l, this.l);
    }
  };
}

// The ship the user controls
var ship = makeSquare(50, canvas.height / 2 - 25, 100, 5);
